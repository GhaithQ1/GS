...
const Get_Shoole_By_Id = () => {
    ...
    useEffect(() => {
        if (!id) return; // لا تعمل شي إذا ما وصل الاي دي
        axios.get(`http://localhost:8000/api/v2/user/${id}`, {
            headers: {
    ...
    useEffect(() => {
        if (!id) return; // لا تعمل شي إذا ما وصل الاي دي
        axios.get(`http://localhost:8000/api/v2/post/getUserPosts/${id}`, {
            headers: {
                Authorization: `Bearer ${cookies.token}`,
            },
        })
                    ...
                    <div className="main_profile_post">
                        <div className="profile">
                            ...
                            <div className="profile_all">
                                <img
                                    src={GetDataById.profilImage ? `http://localhost:8000/user/${GetDataById.profilImage}` : '/image/pngegg.png'}
